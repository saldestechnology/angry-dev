...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-600 via-black to-red-400 text-white overflow-x-hidden" onClick={handleClick}>
      {/* Floating Emojis */}
      <div className="fixed top-[10%] left-[10%] text-4xl animate-bounce pointer-events-none z-10">😡</div>
      <div className="fixed top-[20%] right-[15%] text-4xl animate-bounce pointer-events-none z-10 animation-delay-1000">💢</div>
      <div className="fixed bottom-[30%] left-[5%] text-4xl animate-bounce pointer-events-none z-10 animation-delay-2000">🔥</div>
      <div className="fixed bottom-[10%] right-[10%] text-4xl animate-bounce pointer-events-none z-10 animation-delay-500">😤</div>
      ...
      <div className="max-w-6xl mx-auto px-5">
        ...
        <header className="text-center py-12 relative">
          ...
          <p className="text-2xl mb-8 text-shadow-lg">The Angriest Meta on All of Base</p>
        ...
        <div className="bg-red-500/20 border-4 border-red-500 rounded-2xl p-8 mb-8 shadow-2xl shadow-red-500/50 animate-pulse-red">
          <h2 className="text-4xl text-red-500 text-center mb-8 font-black">THE RAGE IS REAL 🔥</h2>
        ...
        {/* 3D Gallery */}
        <div className="mb-16">
          <h2 className="text-4xl text-red-500 text-center mb-8 font-black">ANGRY DEV GALLERY 😡</h2>
          <Gallery3D />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-12">
          {[
            ...
            <div key={i} className={`bg-black/70 border-2 border-red-500 rounded-lg p-5 text-center transform ${i % 2 ? 'rotate-1' : '-rotate-1'} hover:rotate-0 hover:scale-105 transition-all`}>
              <div className="text-5xl text-red-500 font-black">{stat.number}</div>
              <div>{stat.label}</div>
            </div>
          ))}
        </div>
        ...
        <div className="bg-red-500/10 rounded-2xl p-8 mb-12">
          <h2 className="text-4xl text-red-500 text-center mb-8 font-black">ANGRY DEV QUOTES 💭</h2>
          {[
            ...
            <div key={i} className="text-xl italic mb-5 p-4 bg-black/50 rounded-lg border-l-4 border-red-500">
              {quote}
            </div>
          ))}
        </div>
        ...
        <div className="bg-black/80 rounded-2xl p-8 mb-12">
          <h2 className="text-4xl text-red-500 text-center mb-8 font-black">TOKENOMICS (BECAUSE WE HAVE TO) 📊</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <div key={i} className="text-center">
                <h3 className="text-red-500 text-xl font-bold mb-2">{item.title}</h3>
                <p>{item.value}</p>
              </div>
            ))}
          </div>
        ...
        <div className="bg-red-500/20 border-4 border-red-500 rounded-2xl p-8 mb-12 shadow-2xl shadow-red-500/50">
          <h2 className="text-4xl text-red-500 text-center mb-8 font-black">ROADMAP TO RAGE 🗺️</h2>
          <ul className="space-y-4">
            {[
              ...
              <li key={i} className="bg-red-500/10 p-4 border-l-4 border-red-500 rounded relative pl-12">
        ...
        <div className="bg-black/80 rounded-2xl p-8 mb-12 border-2 border-red-500">
          <h2 className="text-3xl text-red-500 text-center mb-6 font-black">CONTRACT ADDRESS 📋</h2>
        ...
        <div className="bg-red-500/20 border-4 border-red-500 rounded-2xl p-8 mb-12">
          <h2 className="text-4xl text-red-500 text-center mb-8 font-black">WARNING ⚠️</h2>
      ...
      <footer className="text-center py-12 bg-black/80">
        <div className="max-w-6xl mx-auto px-5">
          <p className="text-2xl mb-5">$ANGRY - Built Different, Built Angry 😡</p>
